...
#      SET (LIB_INSTALL_DIR "lib64")
  ...
  IF (EXISTS /etc/suse-release OR EXISTS /etc/SuSE-release OR EXISTS /etc/os-release)
    SET (PACKAGE_FORMAT "RPM")
    ...
    ELSE (CMAKE_SIZEOF_VOID_P MATCHES "8")
      ...
      SET (LIB_INSTALL_DIR "lib")
    ENDIF (CMAKE_SIZEOF_VOID_P MATCHES "8")
  ENDIF (EXISTS /etc/suse-release OR EXISTS /etc/SuSE-release or EXISTS /etc/os-release)
